...
class HardwareStoreSerializer(serializers.ModelSerializer):
    class Meta:
        model = HardwareStore
        fields = ['id', 'owner', 'name', 'area', 'delivery_capacity_units_per_day', 'active', 'created_at']
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = [
            'id', 'store', 'store_name', 'category', 'name', 'brand', 'unit', 
            'specs_json', 'hardware_price_per_unit', 'stock_units', 
            'delivery_eta_hours', 'image', 'active', 'created_at'
        ]
...
class OrderItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OrderItem
        fields = [
            'id', 'product_id', 'quantity_units', 
            'hardware_price_per_unit', 'commission_per_unit', 'final_price_per_unit',
            'products'
        ]
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = [
            'id', 'fundi_id', 'store_id', 'delivery_area', 'delivery_address_note', 
            'status', 'subtotal_hardware', 'commission_total', 'grand_total', 
            'created_at', 'hardware_stores', 'order_items'
        ]
